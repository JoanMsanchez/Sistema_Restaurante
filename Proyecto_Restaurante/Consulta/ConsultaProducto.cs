...
namespace Proyecto_Restaurante.Consulta
{
    public partial class ConsultaProductos : Form
    {
        ...
        private MantenimientoProducto mantenimientoProductoForm = null;
        ...
        {
            if (mantenimientoProductoForm == null || mantenimientoProductoForm.IsDisposed)
            {
                mantenimientoProductoForm = new MantenimientoProducto();

                mantenimientoProductoForm.ProductoGuardado += (s, e) =>
                {
                    llenar_tabla_datagridview(); // refrescar
                };
            }
