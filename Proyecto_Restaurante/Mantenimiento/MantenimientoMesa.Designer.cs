namespace Proyecto_Restaurante.Mantenimiento
{
    partial class MantenimientoMesa
    {
        ...
        private void InitializeComponent()
        {
            ...
            // boxSala
            // 
            boxSala.BackColor = Color.FromArgb(255, 161, 43);
            boxSala.DropDownStyle = ComboBoxStyle.DropDownList;
            boxSala.FlatStyle = FlatStyle.Flat;
            boxSala.Font = new Font("Verdana", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            boxSala.ForeColor = Color.White;
